...
modelPage.setData(data);

console.log(data.carSVG);

//We want to show the Submit Button only if the status of the booking is "Ready".
if(modelSimpleForm.getData().bookingStatus == "Ready") {
...
//Check if some important fields are empty and set value stage accordingly.
if(modelSimpleForm.getData().carLicensePlateNumber == ""){
    InputCarLicensePlateNumber.setValueState("Error");
}
else {
    InputCarLicensePlateNumber.setValueState("None");
}
